...
public class ex08 {
	...
	public static void main(String[] args) {
		...
		/*
		 * Para um cadastro correto, o nome deve ser informado, a idade deve ser maior
		 ...
		 * 
		 * if (idade >= 18) { if (salario >= 1500) { salvar();
		 * 
		 * } else { throw new
		 * IllegalArgumentException("Salário não pode ser menor que 1500"); } } else {
		 * throw new IllegalArgumentException("Idade deve ser maior que 18"); }
		 * 
		 * } else { throw new IllegalArgumentException("Nome deve ser informado"); }
		 */
